...
/**
	...
	SOLUZIONE ESERCIZIO CON DUE CUBI E SCAMBIO TEXTURE
...
void draw(GLFWwindow* window){
	...
	glm::mat4 view = glm::lookAt(glm::vec3(2.5f, 2.5f, 2.5f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(.0f, 1.0f, .0f));

	//glm::mat4 projection = glm::perspective(PI/4, 1.f/1.f, 1.0f, 10.0f);
	glm::mat4 projection = glm::ortho(-2.5f,2.5f,-2.5f,2.5f,1.0f,10.0f);
	glm::mat4 model = glm::rotate(glm::mat4(1.f), PI/2, glm::vec3(0.0f, 1.0f, 0.0f));
	...
	glm::mat4 model2 = glm::rotate(glm::mat4(1.f), PI, glm::vec3(1.0f, 0.0f, 0.0f));
